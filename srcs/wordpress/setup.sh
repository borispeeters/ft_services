...
PHP
wp core install --allow-root --url=http://:5050 --path=/www --title="ft_services" --admin_user=bpeeters --admin_password=fluffclub --admin_email=bpeeters@student.codam.nl --skip-email
